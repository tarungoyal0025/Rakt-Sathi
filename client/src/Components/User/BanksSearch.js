...
const BanksSearch = (props) => {
    ...
    // for the token youve to provide the info of your details
    mapboxgl.accessToken = 'pk.eyJ1IjoidGFydW5nb3lhbDAwMjUiLCJhIjoiY2xrNzJna3FkMDN6NjNmbndud21pcXppaCJ9.l5NfFh2VRh8XOxmvIfldCg';
